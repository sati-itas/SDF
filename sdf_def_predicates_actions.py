...
def predicates_simple()-> Dict[str,Predicate]:
    ...
    has_top_right_neighbour=Predicate("has_top_right_neighbour",o1type=2, o2type=2)       # lane has top right diagonal lane
    has_top_left_neighbour=Predicate("has_top_left_neighbour",o1type=2, o2type=2)         # lane has top left diagonal lane
    has_bottom_right_neighbour=Predicate("has_bottom_right_neighbour",o1type=2, o2type=2) # lane has bottom right diagonal lane
    has_bottom_left_neighbour=Predicate("has_bootom_left_neighbour",o1type=2, o2type=2)   # lane has bottom left diagonal lane 
