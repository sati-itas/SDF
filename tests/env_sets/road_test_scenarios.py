...
def scenario_20(predicates, actions):
    ...
    Agent = SDObject("ego", OType.EGO)
    Car1 = SDObject("car1", OType.VEHICLE)
    lane1 = SDObject("lane1", OType.LANE, x=1, y=0)
    lane2 = SDObject("lane2", OType.LANE, x=1, y=1)
    lane3 = SDObject("lane3", OType.LANE, x=0, y=1)
    lane4 = SDObject("lane4", OType.LANE, x=1, y=2)
    lane5 = SDObject("lane5", OType.LANE, x=0, y=2)
    lane6 = SDObject("lane6", OType.LANE, x=1, y=3)
    lane7 = SDObject("lane7", OType.LANE, x=0, y=3)
    lane8 = SDObject("lane8", OType.LANE, x=1, y=4)
    lane9 = SDObject("lane9", OType.LANE, x=0, y=4)
    lane10 = SDObject("lane10", OType.LANE, x=1, y=5)
    lane11 = SDObject("lane11", OType.LANE, x=0, y=5)
    lane12 = SDObject("lane12", OType.LANE, x=1, y=6)
    lane13 = SDObject("lane13", OType.LANE, x=0, y=6)
    lane14 = SDObject("lane14", OType.LANE, x=1, y=7)
    lane15 = SDObject("lane15", OType.LANE, x=0, y=7)
    lane16 = SDObject("lane16", OType.LANE, x=1, y=8)
    lane17 = SDObject("lane17", OType.LANE, x=0, y=8)
    lane18 = SDObject("lane18", OType.LANE, x=1, y=9)
    lane19 = SDObject("lane19", OType.LANE, x=0, y=9)
    lane20 = SDObject("lane20", OType.LANE, x=0, y=0)
